...
def get_uninstall_plugin_payload(install_payload=None):
    """从安装 payload 中取出 pluginUniqueIdentifier，组装为卸载接口所需的 payload。"""
    payload = install_payload or INSTALL_PLUGIN_PAYLOAD
    return {"pluginUniqueIdentifier": payload["pluginUniqueIdentifier"]}


UNINSTALL_PLUGIN_PAYLOAD = get_uninstall_plugin_payload()

# 轮询配置
INSTALL_TASK_POLL_INTERVAL_SEC = 3
INSTALL_TASK_TIMEOUT_SEC = 60
...
APPLY_PLUGIN_PAYLOAD = {
    "pluginUniqueIdentifier": "langgenius/github:0.3.1@d11d1199e99933a27fc210a3cb5579addb51a97e80b9f26dfb165eac6a6eadf5",
    "tenantIds": [
        "f0435a59-fc6b-4d40-a478-6a53d00bb922",
    ],
}
...
class TestE2ECase4P0:
    ...
    def test_install_tool_plugin(self, admin_client, resource_tracker):
        """
    ...
    def test_install_model_plugin(self, admin_client, resource_tracker):
        pass
